...
<div class="flex flex-col items-center w-full gap-12 px-4">
	...
	<footer class=" text-gray-300 backdrop-blur-[2px] -mx-4 p-4 border-primary-500 border-t">
		<div class="text-center flex items-center flex-col gap-2 antialiased mb-4">
			...
			<p class="text-xl font-semibold mb-3">{$t('home.footer.title')}</p>
			<div
				class="lg:w-2/3 md:w-3/4 bg-black text-justify p-8 bg-opacity-30 mx-auto mb-5 rounded flex flex-col gap-2"
			>
				<blockquote>
					« {$t('home.footer.citation')} »
					<br />
					<div class=" italic font-semibold">{$t('home.footer.citationInfo')}</div>
				</blockquote>
